...
#region Task4
    public static IEnumerable<char> DoTask4(string text)
    {
        ...
        //убираем повторяющиеся с помощью хашсета
...
#region Task5
    ...
    public static void DoTask5(string file)
    {
        try
        {
            ...
            //считывая фаил формируем объекты из задания
    ...
    // метод для поиска повторяющихся элементов в отсортированном списке
